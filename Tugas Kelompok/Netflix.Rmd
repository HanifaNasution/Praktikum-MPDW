...
### Model Tanpa Intersept dan Drift (Data train dikasih diff)
...
### Model Dengan Intercept Tanpa Drift (data diff tanpa diff)
...
### Model Tanpa Intercept Dengan Drift (data train dikasih diff + include.drift)
...
####ARIMA(1,1,1) aic = -2078.09; tidak ada signifikan
ERROR karena tidak stasioner di warningnya
```{r}
...
####ARIMA(2,1,3) aic = -2072.16; tidak ada signifikan
ERROR karena tidak stasioner diwarningnya
```{r}
...
### Model Dengan Intercept dan Drift (data diff tidak dikasih diff + include.drift)
...
Model terbaik dilihat dari model dengan seluruh parameter signifikan dan AIC paling kecil 
Didapat model dengan semua parameter signifikan adalah ARIMA (0,1,1) dengan AIC -2068.36 menggunakan metode ML, ARIMA(4,1,4) dengan AIC -2074,75 tanpa intercept dan drift menggunakan metode CSS-ML
Karena ARIMA (4,1,4) lebih kecil AIC nya maka dipilih model ARIMA (4,1,4) sebagai model terbaik
